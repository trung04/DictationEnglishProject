          ...
          <div className="row">
            <div className="col-12 mb-5 text-center">
              ...
              <p className="mt-4" style={{ maxWidth: "650px", margin: "auto" }}>
                Currently, there are more than 1000 exercises on our website,
                they are divided into different topics. Below is the list of{" "}
                <Link to="/exercises">all the topics</Link> and some exercises
                for each of them:
              </p>
            </div>
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  {/* <hr> */}
                  <p>
                    A collection of audio articles introducing culture, people,
                    places, historical events and daily life in English-speaking
                    countries, especially Canada and America.
                  </p>
                  <ul>
                    <li>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  <h3>
                    <Link to="/exercises/english-conversations">
                      Daily Conversations
                    </Link>
                  </h3>
                  {/* <hr> */}
                  <p>
                    Short and fun English conversations in common situations you
                  ...
                  <Link to="https://dailydictation.com/exercises/english-conversations">
                    View all
                  </Link>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  {/* <hr> */}
                  <p>
                    In this section, there are a lot of conversations and short
                    talks in everyday life and at work. Let's practice and
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  <h3>
                    <Link to="https://dailydictation.com/exercises/youtube">
                      YouTube
                    </Link>
                  </h3>
                  {/* <hr> */}
                  <p>
                    Are you bored with English lessons for students? Let's learn
                    real English from YouTube videos that native speakers watch
                    and enjoy!
                  </p>
                  <ul>
                    <li>
              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <p>
                    ...
                    &amp; academic talks. These recordings are mainly in British
              ...
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  <p>
                    ...
                    lectures, mainly in American English. These recordings will
                    help you to get better preparation if you are planning to
                    study in an English-speaking country, especially the US and
                    Canada.
                  </p>
                  <ul>
                    <li>
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  {/* <hr> */}
                  <p>
                    Let's learn and practice the English alphabet by spelling
            ...
            <div className="col-md-6">
              <div className="card mb-4">
                <div className="card-body">
                  ...
                  {/* <hr> */}
                  <p>
                    Let's improve your ability to understand English numbers
                    when they are spoken quickly by an American.
                  </p>
                  <ul>
                    <li>
